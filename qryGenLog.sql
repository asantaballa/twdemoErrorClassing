...
If OBJECT_ID(N'tempdb..#ErrorLogGenPatterns', N'U') Is Not Null
...
, ( 'Security violation detected user {n}, access {n2}', 100)
, ( 'Attemp to save failed, reason 12', 10)
, ( 'Attemp to save failed, reason 16', 10)
